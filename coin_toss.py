...
def coin_toss_tensor(n):
    ...
    faces = pyro.sample(
        'faces',
        pyro.distributions.Bernoulli(0.5 * torch.ones(n))
    )
    ...
    return Counter({"head": heads, "tail": tails}), total
